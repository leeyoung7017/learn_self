...
/**************************************控件地址***************************************/
typedef struct{
	uint32_t name_addr;	//产品名地址
	uint32_t max_addr;	//上限地址
	uint32_t min_addr;	//下限地址
	uint32_t corr_addr; //修正系数地址
}Widget_ADDR;

typedef struct{
	uint32_t LOG_name_addr;
	uint32_t LOG_middle_addr;
	uint32_t LOG_max_addr;
	uint32_t LOG_min_addr;
	uint32_t LOG_time_addr;
}LOG_ADDR;
